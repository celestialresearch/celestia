...
func TestTransform(t *testing.T) {
	...
	tests := []struct {
		...
		{"uppercase hostname", "https://Example.test/", Defang, "hxxps://Example[.]test/"},
...
func TestTransformRejects(t *testing.T) {
	...
	tests := []struct {
		...
		{"leading empty label", "https://.example/"},
		{"interior empty label", "https://example..test/"},
		{"defanged empty label", "hxxps://example[.][.]test/"},
