	...
	directories := []splitDirectory{
		...
		},
		{
			...
			files: []string{
				...
				"inspection_concurrency_test.go", "lock.go", "lock_fail_closed_test.go", "lock_linux_amd64.go",
				"lock_fault_injection_windows_test.go", "lock_process_test.go", "lock_root.go",
				"lock_root_test.go", "lock_test.go", "lock_windows.go", "lock_windows_test.go",
				"observation_validation.go", "observation_validation_test.go", "ownership.go",
				"ownership_test.go", "paths.go", "paths_fault_test.go", "platform.go", "platform_linux_amd64_test.go",
				"publish.go", "publish_fault_windows_test.go", "publish_result_test.go",
				"publish_linux_amd64.go", "publish_test.go", "publish_windows.go",
				"publish_windows_test.go", "record.go", "record_linux_amd64.go",
				...
				"recovery_interruption_test.go", "recovery_test.go",
				"repair_fault_windows_test.go", "repair_windows.go", "request_v1.go",
				"request_v1_test.go", "root.go", "root_linux_amd64.go",
