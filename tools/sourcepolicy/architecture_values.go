...
func expectedPackages() []string {
	return []string{
		...
		"tools/actionpolicy", "tools/linuxamd64feasibility", "tools/sourcepolicy",
	}
}
...
func expectedScripts() []string {
	return []string{
		...
		".github/scripts/rustadvisorycheck.sh", ".github/scripts/rustcheck.sh",
		".github/scripts/testcheck.sh",
