...
func expectedPackages() []string {
	return []string{
		...
		"internal/urloperation", "internal/operation/urlreference/transform", "internal/workerprotocolv1",
...
func expectedRetiredMigration() []string {
	return []string{"internal/processsupervision", "internal/urlreferencev1"}
}
